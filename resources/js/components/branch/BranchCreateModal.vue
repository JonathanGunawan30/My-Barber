                ...
                >
                    ...
                    <div class="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Add New Branch</h2>
                                <p class="text-sm text-gray-600 dark:text-gray-400">Create a new barbershop branch location</p>
                            </div>
                        </div>
                        <button
                            @click="closeModal"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input
                                            ...
                                            type="text"
                                            required
                                            placeholder="Enter branch name (e.g., Barbershop Tangerang)"
...
import { Building, MapPin, Upload, X, Loader2 } from 'lucide-vue-next'
