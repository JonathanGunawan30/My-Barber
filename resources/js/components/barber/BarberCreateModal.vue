                ...
                >
                    ...
                    <div class="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Add New Barber</h2>
                                <p class="text-sm text-gray-600 dark:text-gray-400">Create a new barber profile</p>
                            </div>
                        </div>
                        <button
                            @click="closeModal"
                    ...
                    <div class="p-6 overflow-y-auto">
                        <form @submit.prevent="submitForm" class="space-y-6">
                            <!-- Barber Name -->
                            <div>
                                <label for="barber-name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    Barber Name *
                                </label>
                                <div class="relative">
                                    <input
                            ...
                            <div class="flex justify-end space-x-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                                ...
                                >
                                    ...
                                    <span>{{ isSubmitting ? 'Creating...' : 'Create Barber' }}</span>
                                </button>
                            </div>
                        </form>
                    </div>
...
import { User, Building, Upload, X, Loader2, UserPlus } from 'lucide-vue-next'
...
const submitForm = async () => {
    ...
    try {
        ...
        router.post('/admin/barbers', formData, {
            forceFormData: true,
            onSuccess: () => {
                resetForm()
                emit('created')
