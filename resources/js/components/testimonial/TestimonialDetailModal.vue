                    ...
                    <div class="relative bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-6 flex-shrink-0">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Testimonial Details</h2>
                                    <p class="text-gray-600 dark:text-gray-400 mt-1">Review & Information</p>
                                </div>
                            </div>
                            <button
                                @click="closeModal"
                        ...
                        <div class="absolute top-6 right-16 flex items-center gap-1">
                            <Star v-for="star in 5" :key="star" :class="['w-6 h-6', star <= testimonial.rating ? 'text-yellow-400 fill-current' : 'text-gray-300 dark:text-gray-600']" />
                            <span class="ml-1 text-lg font-medium text-gray-800 dark:text-gray-200">({{ testimonial.rating }}/5)</span>
                        </div>
                    </div>
                        ...
                        <div class="space-y-6">
                            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
                                    <MessageSquareText class="w-5 h-5 mr-2 text-blue-600 dark:text-blue-400" />
                                    Review Information
                                </h3>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center bg-white dark:bg-gray-800 px-3 py-2 rounded border">
                                            <Star v-for="star in 5" :key="star" :class="['w-5 h-5', star <= testimonial.rating ? 'text-yellow-400 fill-current' : 'text-gray-300 dark:text-gray-600']" />
                                            <span class="ml-2 text-gray-900 dark:text-white">({{ testimonial.rating }}/5)</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
                                    <MessageSquareText class="w-5 h-5 mr-2 text-green-600 dark:text-green-400" />
                                    Customer Comment
                                </h3>
                    ...
                    <div class="border-t border-gray-200 dark:border-gray-700 px-6 py-4 bg-gray-50 dark:bg-gray-700/30 flex-shrink-0">
                        <div class="flex justify-between items-center">
                            <div class="text-sm text-gray-600 dark:text-gray-400">
                                Testimonial ID: {{ testimonial.id }} • Last updated {{ formatRelativeTime(testimonial.updated_at) }}
                            </div>
...
import {
    Eye, X, MessageSquareText, Star, Clock, Pencil
