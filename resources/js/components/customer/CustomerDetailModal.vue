                ...
                >
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 dark:text-gray-400 mt-1">Customer Details & Information</p>
                                </div>
                            </div>
                            <button
                                @click="closeModal"
                    ...
                    <div class="flex-grow p-6 overflow-y-auto">
                        <div class="space-y-6">
                            ...
                            <!-- OAuth Information -->
                            <div v-if="customer.google_id || customer.avatar" class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
                                    <Globe class="w-5 h-5 mr-2 text-purple-600 dark:text-purple-400" />
                                    OAuth Information
                                </h3>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div v-if="customer.google_id">
                                        <label class="block text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">
                                            Google ID
                                        </label>
                                        <p class="text-gray-900 dark:text-white font-mono bg-white dark:bg-gray-800 px-3 py-2 rounded border break-all">
                                            {{ customer.google_id }}
                                        </p>
                                    </div>
                                    <div v-if="customer.avatar">
                                        ...
                                        <div class="bg-white dark:bg-gray-800 border rounded-lg p-2 flex items-center justify-center h-24 w-24">
                                            <img :src="customer.avatar" alt="Customer Avatar" class="rounded-full object-cover w-full h-full" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="border-t border-gray-200 dark:border-gray-700 px-6 py-4 bg-gray-50 dark:bg-gray-700/30 flex-shrink-0">
                        <div class="flex justify-between items-center">
                            <div class="text-sm text-gray-600 dark:text-gray-400">
                                Customer ID: {{ customer.id }} • Last updated {{ formatRelativeTime(customer.updated_at) }}
                            </div>
...
const formatRelativeTime = (dateString) => {
    ...
    if (diffInSeconds < 31536000) return `${Math.floor(diffInSeconds / 31536000)} months ago`
