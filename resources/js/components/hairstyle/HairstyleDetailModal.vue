<template>
                    ...
                    <div class="relative bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-6 flex-shrink-0">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white">{{ hairstyle.name }}</h2>
                                    <p class="text-gray-600 dark:text-gray-400 mt-1">Hairstyle Details & Information</p>
                                </div>
                            </div>
                            <button
                                @click="closeModal"
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
                                    <Palette class="w-5 h-5 mr-2 text-blue-600 dark:text-blue-400" />
                                    Basic Information
                                </h3>
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <span class="text-sm text-gray-500 dark:text-gray-400">
                                              {{ hairstyle.is_featured ? 'This hairstyle is highlighted.' : 'This hairstyle is not highlighted.' }}
                                            </span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
                                    <Image class="w-5 h-5 mr-2 text-purple-600 dark:text-purple-400" />
                                    Hairstyle Photo
                                </h3>
                                <div v-if="hairstyle.photo" class="space-y-3">
                                ...
                                <div v-else class="text-center py-8">
                                    ...
                                    <p class="text-sm text-gray-400 dark:text-gray-500 mt-1">Upload a photo to showcase this hairstyle</p>
                                </div>
                            </div>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-900 dark:text-white bg-white dark:bg-gray-800 px-3 py-2 rounded border">
                                            {{ formatDate(hairstyle.updated_at) }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="border-t border-gray-200 dark:border-gray-700 px-6 py-4 bg-gray-50 dark:bg-gray-700/30 flex-shrink-0">
                        <div class="flex justify-between items-center">
                            <div class="text-sm text-gray-600 dark:text-gray-400">
                                Hairstyle ID: {{ hairstyle.id }} • Last updated {{ formatRelativeTime(hairstyle.updated_at) }}
                            </div>
    ...
    >
        ...
        >
            ...
            >
                <div v-if="showImageModal && hairstyle?.photo" class="relative max-w-6xl max-h-full">
                    <img
                        :src="`/storage/${hairstyle.photo}`"
                        :alt="hairstyle.name"
                    ...
                    <div class="absolute bottom-4 left-4 bg-black bg-opacity-75 text-white p-4 rounded-lg max-w-md">
                        <h3 class="font-semibold text-lg">{{ hairstyle.name }}</h3>
                        <p class="text-gray-300 mt-1">{{ hairstyle.description }}</p>
                    </div>
                </div>
            </Transition>
        </div>
...
import {
    Eye, X, Palette, MessageSquareText, Image, Clock, Pencil, ZoomIn
